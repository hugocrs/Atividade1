 ...
 * 
 */
@WebServiceClient(name = "ExemploServiceImplService", targetNamespace = "http://iftm.com/", wsdlLocation = "http://localhost:8080/exemplo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXEMPLOSERVICEIMPLSERVICE_QNAME = new QName("http://iftm.com/", "ExemploServiceImplService");
    ...
    public ExemploService getExemploServiceImplPort() {
        return super.getPort(new QName("http://iftm.com/", "ExemploServiceImplPort"), ExemploService.class);
    }
    ...
    public ExemploService getExemploServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://iftm.com/", "ExemploServiceImplPort"), ExemploService.class, features);
    }
